...
#             gyvunai.append(user['name'])
#             # gyvunai.append(user)
#
#     print("Vartotojai su gyvunais ar be jų: ", gyvunai)
    ...
    for user in users:
        if user['age'] <= 18:
            if user['hasDog'] == True or user['hasCat'] == True:
                # nepilnameciai.append(user)
                nepilnameciai.append(user['name'])
    print("Nepilnamečiai, kurie turi gyvuna: ", nepilnameciai)
